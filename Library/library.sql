...
WHERE B.B_ID=A.B_ID AND B.B_ID=C.B_ID AND L.BRANCH_ID=C.BRANCH_ID;
...
CREATE VIEW VPUBLICATION
AS SELECT PUB_YEAR
FROM BOOK;

SELECT*FROM VPUBLICATION;

# Create a view of all books and its number of copies that are currently available in theLibrary.
CREATE VIEW VBOOKS
AS SELECT B.B_ID, B.TITLE, C.NO_OF_COPIES
FROM BOOK B, BOOK_COPIES C, LIBRARY_BRANCH L
WHERE B.B_ID=C.B_ID AND C.BRANCH_ID=L.BRANCH_ID;
